...
prediction[['context_id', 'reply_id']].to_csv(path+'/sub_svd_counter_ridge.tsv',header=None, index=False, sep=' ')
prediction.to_csv(path+'/sub_rank_svd_counter_ridge.tsv', sep=' ')

pickle.dump(models, open(path+'/svd_counter_ridge.pickle.dat', 'wb'))
