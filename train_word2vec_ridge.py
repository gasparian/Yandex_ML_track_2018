...
prediction[['context_id', 'reply_id']].to_csv(path+'/sub_w2v_lr.tsv',header=None, index=False, sep=' ')
prediction.to_csv(path+'/sub_rank_w2v_lr.tsv', sep=' ')

pickle.dump(models, open(path+'/w2v_lr.pickle.dat', 'wb'))
