...
prediction[['context_id', 'reply_id']].to_csv(config.path+'/data/sub_chars_counter_ridge.tsv',header=None, index=False, sep=' ')
prediction.to_csv(config.path+'/data/sub_rank_chars_counter_ridge.tsv', sep=' ')

pickle.dump(models, open(config.path+'/models/chars_counter_ridge.pickle.dat', 'wb'))
