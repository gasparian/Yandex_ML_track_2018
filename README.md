...
### Problem:
  ...
  Predict the most relevant reply to the context. Context usually consists of 3 replicas with several replies. Each replica has relevance and confidence - let use it's product as target variable.
