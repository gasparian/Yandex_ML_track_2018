...
prediction[['context_id', 'reply_id']].to_csv(path+'/sub_words_tfidf_ridge.tsv',header=None, index=False, sep=' ')
prediction.to_csv(path+'/sub_rank_words_tfidf_ridge.tsv', sep=' ')

pickle.dump(models, open(path+'/words_tfidf_ridge.pickle.dat', 'wb'))
